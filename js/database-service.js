// Plik: EazyKoszt 0.6.1A-database-service.js
...
class DatabaseService {
    constructor(dbName, dbVersion, storeSchemas) {
        ...
        this.db = null;
        console.log(`DatabaseService (EazyKoszt 0.6.1A) zainicjalizowany dla bazy: ${dbName}, wersja: ${dbVersion}`);
    }
...
console.log("Plik EazyKoszt 0.6.1A-database-service.js załadowany.");